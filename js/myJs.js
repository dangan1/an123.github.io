...
function firstQuestion(){
    ...
    $('.content').hide();
    Swal.fire({
        title: 'Hé luu chị tiến!',
        text: 'em muốn hỏi chị câu này nè, nhớ phải trả lời thật lòng nhaaa.',
...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: 'Sao mà chị thích a dậyyy :vvvv',
        html: true,
        width: 900,
        padding: '3em',
        ...
        if (result.value) {
            Swal.fire({
                ...
                background: '#fff url("img/iput-bg.jpg")',
                title: 'anh biết mà ^^ Yêu chị 300.000',
